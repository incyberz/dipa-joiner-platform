  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
        <h1 data-aos="fade-up">LMS FKOM</h1>
        <h2 data-aos="fade-up" data-aos-delay="400" id="sub_h1">
          Belajar Tanpa Batas,
          <span class="brown">Belajar Kapan saja,</span>
          <span class="darkblue">dimana saja.</span>
          <span class="green">&nbsp;</span>
          &nbsp;
        </h2>
        <div class="flexy flex-center">
          <div data-aos="fade-up" data-aos-delay="800">
            <a href="?join" class="btn-get-started scrollto">Daftar</a>
          </div>
