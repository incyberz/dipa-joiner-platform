...
echo "
  ...
  <hr>
    ...
    <br>tahun_ajar: <span id=tahun_ajar>$ta</span>
...
echo "
  ...
  <hr>
    ...
    <br>room: <span id=room>$singkatan_room</span>
    ...
    <br>total_peserta [$singkatan_room]: <span id=total_peserta>$total_peserta</span>
  </div>
";
