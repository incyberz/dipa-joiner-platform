...
$rdesc = [
  'nama' => "Nama $Jenis yang tampil ke $peserta_title",
  ...
  'basic_point' => "Sebelum $jenis di closing oleh instruktur, $peserta_title akan tetap mendapat Basic Point secara penuh",
  'ontime_point' => "Ontime Point adalah poin tambahan bagi $peserta_title yang mengerjakan $jenis secara Ontime",
  ...
  'cara_pengumpulan' =>  "Cara $peserta_title mengumpulkan $jenis dari instruktur",
