...
if (isset($_POST['btn_move_up'])) {
  ...
  echo div_alert('danger', "Maaf, fitur [move-up-urutan-sesi] in development. Mohon hubungi developer untuk info lebih lanjut!");
  jsurl('', 3000);
}
...
if (isset($_POST['btn_add_sesi'])) {
  ...
  echo div_alert('danger', "Maaf, fitur [add-sesi] in development. Mohon hubungi developer untuk info lebih lanjut!");
  jsurl('', 3000);
