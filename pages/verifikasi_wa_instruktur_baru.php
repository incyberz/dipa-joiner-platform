...
$text_wa = "*REQUEST $SEBAGAI BARU*%0a%0aYth. Master $Trainer $Nama_LMS ($ops[nama]),%0a%0aSaya $nama, mengajukan Request sebagai *$SEBAGAI BARU* atas username: *$username* dengan nomor-wa-aktif: *$no_wa*. Mohon untuk segera diverifikasi agar saya dapat melanjutkan ke Manage Akun selanjutnya. Terimakasih.%0a%0aLink:%0a$link_encoded %0a%0a [$Nama_LMS Apps, $tanggal]";
...
set_h2('Verif WA', "Berikut adalah link dan pesan yang akan diteruskan ke Master $Trainer");
