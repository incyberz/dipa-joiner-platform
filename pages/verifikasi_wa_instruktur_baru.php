...
$text_wa = "*REQUEST $SEBAGAI BARU*%0a%0aYth. Master $Instruktur $DIPAJoiner ($devs[nama]),%0a%0aSaya $nama, mengajukan Request sebagai *$SEBAGAI BARU* atas username: *$username* dengan nomor-wa-aktif: *$no_wa*. Mohon untuk segera diverifikasi agar saya dapat melanjutkan ke Manage Akun selanjutnya. Terimakasih.%0a%0aLink:%0a$link_encoded %0a%0a [$DIPAJoiner Apps, $tanggal]";
...
<div class="wadah gradasi-hijau" data-aos-zzz="fade-up" data-aos-delay="150">
  ...
  <div class="form-group">
    <a target="_blank" href='https://api.whatsapp.com/send?phone=<?= $devs['whatsapp'] ?>&text=<?= $text_wa ?>' class="btn btn-primary btn-block">Kirim Pesan Verifikasi</a>
  </div>
</div>