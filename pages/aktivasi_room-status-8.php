...
$arr = [
  'learning_path' => [
    ...
    'desc' => "Membaca materi yang diberikan oleh $Trainer. Materi dapat berupa teks paragraf, modul PDF, rekaman mp3, atau video pembelajaran. Jika $Trainer belum memberikan materi maka $Peserta belum bisa Tanam Soal, Play Quiz, atau aktifitas lainnya. $Trainer wajib: 1. Update nama sesi (Learning Path); 2. Input tag-tag materi. Opsi lain bersifat opsional.",
    'options' => [
  ...
  'tanam_soal' => [
    ...
    'desc' => "Untuk membuktikan bahwa $Peserta sudah mengakses Learning Path maka $Peserta_title wajib membuat Soal PG lengkap dengan opsi dan kunci jawabannya. Dalam kalimat soal atau opsi-opsinya wajib terdapat tag-tag yang ditentukan oleh $Trainer pada Learning Path.",
    'options' => [
  ...
  'latihan' => [
    ...
    'image' => 'latihan.png',
    'desc' => "Yaitu upload bukti mengerjakan latihan (jika sudah ada). $Trainer harus membuat latihan, menentukan poin, petunjuk pengerjaan, sifat latihan (opsional atau wajib) dan menentukan waktu pengerjaannya. Secara default $Peserta menjawab di buku catatan, difoto, kemudian diupload pada latihan tersebut.",
    'options' => [
  ...
  'challenge' => [
    ...
    'image' => 'challenge.png',
    'desc' => "Yaitu misi/tugas special dari $Trainer, Praktisi, atau Dunia Industri. Reward sangat besar sesuai dengan Sub Level Challenge tersebut. Reward dapat berupa points, promotions, atau bahkan Rupiah. Goal Challenge bersifat praktis artinya hampir sesuai dengan yang dibutuhkan oleh Dunia Industri. $Trainer bertindak sebagai manager challenge baik yang berasal dari $Trainer itu sendiri atau dari Praktisi/Dunia Industri.",
    'options' => [
      0 => 'None - Semua challenge bersifat opsional',
      1 => "Wajib mengerjakan challenge dari $Trainer saja",
  ...
  'project' => [
    ...
    'image' => 'project.png',
    'desc' => "Pembuktian keilmuan $Peserta dengan cara membuat produk, alat, atau layanan (jasa) yang siap dipasarkan (digunakan) di Dunia Industri. $Peserta_title, $Trainer, dan Pihak Industri harus terlibat dalam pembuatan System Requirements, Progress report, dan Budgeting. $Trainer wajib membuat MoU dan MoA agar Project Goal dapat terwujud dalam waktu sekitar satu semester.",
    'options' => [
