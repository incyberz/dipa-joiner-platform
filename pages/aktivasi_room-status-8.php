...
$arr = [
  'learning_path' => [
    ...
    'desc' => "Membaca materi yang diberikan oleh instruktur. Materi dapat berupa teks paragraf, modul PDF, rekaman mp3, atau video pembelajaran. Jika instruktur belum memberikan materi maka $peserta_title belum bisa Tanam Soal, Play Quiz, atau aktifitas lainnya. Instruktur wajib: 1. Update nama sesi (Learning Path); 2. Input tag-tag materi. Opsi lain bersifat opsional.",
    'options' => [
  ...
  'tanam_soal' => [
    ...
    'desc' => "Untuk membuktikan bahwa $peserta_title sudah mengakses Learning Path maka $Peserta_title wajib membuat Soal PG lengkap dengan opsi dan kunci jawabannya. Dalam kalimat soal atau opsi-opsinya wajib terdapat tag-tag yang ditentukan oleh instruktur pada Learning Path.",
    'options' => [
  ...
  'quiz' => [
    'caption' => 'Play Quiz',
    'image' => 'quiz.png',
    'desc' => "Yaitu menjawab (atau me-reject) soal-soal yang dibuat oleh $peserta_title lain pada satu Room melalui proses Tanam Soal. Default waktu menjawab adalah 30 detik. Baik menjawab dengan benar ataupun salah tetap mendapat poin. Jika ingin me-reject harus memilih salah satu alasan, apakah tidak ada jawaban, soal asal-asalan, atau alasan lainnya.",
    'options' => [
  ...
  'latihan' => [
    ...
    'image' => 'latihan.png',
    'desc' => "Yaitu upload bukti mengerjakan latihan (jika sudah ada). Instruktur harus membuat latihan, menentukan poin, petunjuk pengerjaan, sifat latihan (opsional atau wajib) dan menentukan waktu pengerjaannya. Secara default $peserta_title menjawab di buku catatan, difoto, kemudian diupload pada latihan tersebut.",
    'options' => [
  ...
  'project' => [
    ...
    'image' => 'project.png',
    'desc' => "Pembuktian keilmuan $peserta_title dengan cara membuat produk, alat, atau layanan (jasa) yang siap dipasarkan (digunakan) di Dunia Industri. $Peserta_title, Instruktur, dan Pihak Industri harus terlibat dalam pembuatan System Requirements, Progress report, dan Budgeting. Instruktur wajib membuat MoU dan MoA agar Project Goal dapat terwujud dalam waktu sekitar satu semester.",
    'options' => [
...
<div class='wadah gradasi-hijau'>
  <p class='tengah f20 darkblue'>Syarat agar $peserta_title dapat mengisi Presensi Online:</p>
  <hr>
  <table class='table'>
    <thead>
      <th width=20%>&nbsp;</th>
