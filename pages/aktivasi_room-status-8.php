...
$arr = [
  ...
  'tanam_soal' => [
    ...
    'desc' => "Untuk membuktikan bahwa $Peserta sudah mengakses Learning Path maka $Peserta wajib membuat Soal PG lengkap dengan opsi dan kunci jawabannya. Dalam kalimat soal atau opsi-opsinya wajib terdapat tag-tag yang ditentukan oleh $Trainer pada Learning Path.",
    'options' => [
  ...
  'project' => [
    ...
    'image' => 'project.png',
    'desc' => "Pembuktian keilmuan $Peserta dengan cara membuat produk, alat, atau layanan (jasa) yang siap dipasarkan (digunakan) di Dunia Industri. $Peserta, $Trainer, dan Pihak Industri harus terlibat dalam pembuatan System Requirements, Progress report, dan Budgeting. $Trainer wajib membuat MoU dan MoA agar Project Goal dapat terwujud dalam waktu sekitar satu semester.",
    'options' => [
