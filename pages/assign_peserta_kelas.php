...
$opt .= "<option value=all>Cari $Peserta</option>";
...
# FINAL OUTPUT 
# ==================================================
$Semua_Peserta = $from_kelas ? "$Peserta dari kelas: $from_kelas" : "Cari $Peserta";

$blok_filter = "<div class='d-flex'>
  <div class='flex-fill'>
    <select class='form-control'>
      <option>All Prodi</option>
    </select>
  </div>
  <div class='flex-fill'>
    <select class='form-control'>
      <option>All Smt</option>
    </select>
  </div>
</div>
";
